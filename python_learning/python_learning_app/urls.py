...
urlpatterns = [
    ...
    path('signup_view', index.SignupView.as_view(), name='signup_view'),
    path('signed_view', index.SignedView.as_view(), name='signed_view'),
    ...
    path('intro_ex/<int:pk>', intro.IntroCourseView.as_view(), name='intro_ex'),
    path('questions_beginner', drill.QuestionsBeginner.as_view(), name='questions_beginner'),
